PennController.Sequence("age", "*sent", "init", "instr","practice1","practice2", randomize("exp5Task"),"upload", "send" ,"debrief", "exit" );
...
PennController( "instr" ,
        ...
        newText("<p>On each trial of this experiment, you will see a series of images presented one by one. <br/> Your task is to create a well-formed sentence using the elements illustrated in the pictures.<br/> The image in the blue square will be the verb in each sentence.</p>")
        ,
        ...
        ,
        newText("<p>Each trial will start when you press the purple button, at which point you will see each picture.<br/>  You should describe the picture outloud, then press the SPACE BAR to continue.</p>")
        ,
        newText("<br/>")
        ,
...
PennController( "practice2" ,
        ...
        newImage("clock", "clock.bmp") //TIME PICTURE w/text
            .size(200,200)
        ,
        ...
        newImage("obj1", "obj163.bmp") //OBJ PICTURE w/black border
            .size(250,250)
        ,
        getCanvas("screen")
            .add("center at 100%","middle at 40%", getImage("obj1"))
        ...
        ,
        newText("exp2","<p>\"The unicorn counts the flowers.\" </p>") //edit to match pictures
        ,
        newText("exp3","<p>That's pretty much it.  There are 48 trials, which will probably take you about 10 minutes to complete.</p>") //how many trials
        ,
        newText("exp4", "<p>Please press below when you are ready to begin.</p>")
        ,
        ...
        getCanvas("screen")
            ...
            .add("center at 50%","middle at 45%", getText("exp3"))
            .add("center at 50%","middle at 55%", getText("exp4"))
            .add("center at 50%","middle at 65%", getButton("button"))
            .print()
        ,
        getButton("button").wait()
