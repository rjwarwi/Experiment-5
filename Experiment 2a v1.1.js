PennController.Sequence("consent","init", "audio_check", "instr","practice1","practice2", randomize("2a"),"debrief", "exit" );
...
,
        newText("exp1","<p>So there you saw one string of letters (LEANING) and then another string of letters (RESTING)")
        ,
        newText("exp2","You had to say the second string of letters (RESTING) out loud into your computer's microphone.")
...
.remove(getText("target"))
,
newText("exp1","<p>So there you saw one string of letters (ABSORBING) and then another string of letters (SHIRTLESS)")
,
newText("exp2","You had to say the second string of letters (SHIRTLESS) out loud into your computer's microphone")
,
newText("exp3", "That's pretty much it.  The rest of the experiment will probably take you about 10 minutes to complete.")
,
...
PennController.Template( "exp2a.csv" ,
    variable => PennController( "2a" ,
...
newMediaRecorder(variable.Item+"_"+PennController.GetURLParameter("id"),"audio")
        ...
        ,
        newTimer("timeout", 10000).start().log().wait()
,
