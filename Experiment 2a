PennController.Sequence("consent","init", "instr","practice1","practice2", randomize("2a"),"debrief", "exit" );
...
.remove(getText("target"))
,
newText("exp1","<p>So there you saw one string of letters (ABSORBING) and then another string of letters (THUTTSING)")
,
newText("exp2","You had to say the second string of letters (THUTTSING) out loud into your computer's microphone")
,
newText("exp3", "That's pretty much it.  There are 400 trials, which will probably take you about 15 minutes to complete.")
,
