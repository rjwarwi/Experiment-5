PennController.Sequence("age", "*sent", "init", "audio_check", "instr","practice1","practice2", randomize("exp5Task"),"upload", "send" ,"debrief", "exit" );
...
newTrial( "audio_check" ,
    ...
    ,
    newText("instr-1", "Before starting, record a brief test and play it back to ensure your microphone is adjusted properly.")
    ,
...
PennController( "instr" ,
        ...
        ,
        newText("<p>Each trial will start when you press the SPACE KEY, at which point you will see each picture.<br/>  You should describe the picture outloud, then press the SPACE KEY to continue.</p>")
        ,
        newText("<br/>")
        ,
...
PennController( "practice2" ,
        ...
        ,
        newText("exp2","<p>\"The unicorn counts flowers.\" </p>") //edit to match pictures
        ,
        ...
        ,
        newText("exp4", "<p>Remember to press the SPACE KEY when you finish speaking your sentence out loud.<p>")
            .bold()
        ,
        newText("exp5", "<p>Please press below when you are ready to begin.</p>")
        ,
        
        getCanvas("screen")
            .add("center at 50%","middle at 5%", getText("exp1"))
            .add("center at 50%","middle at 15%", getText("exp2"))
            .add("center at 50%","middle at 45%", getImage("example2"))
            .add("center at 50%","middle at 75%", getText("exp3"))
            .add("center at 50%","middle at 85%", getText("exp4"))
            .add("center at 50%","middle at 95%", getText("exp5"))
